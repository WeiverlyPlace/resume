...
% margins
\geometry{left=1.28cm, right=1.28cm, top=1.32cm, bottom=1.32cm}
% header and footer
\pagestyle{fancy}
...
\begin{document}
  ...
  \begin{resumeItemize}
    ...
    \resumeItem
    {Designed and developed the Beam SDK integration backend (mobile and web) from scratch to launch, as well as the upcoming partner portal, unification of the Beam app and SDK, and client-specific projects, including complete database models, RESTful API endpoints, infrastructure and architecture, test suites, and client-configurable features}
    \resumeItem
